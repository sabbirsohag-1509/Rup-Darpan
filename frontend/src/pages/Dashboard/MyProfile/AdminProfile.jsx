...
const AdminProfile = () => {
  ...
  const {
    ...
    queryKey: ["admin-profile-bookings"],
    queryFn: async () => {
  ...
  const {
    ...
    queryKey: ["admin-profile-reviews"],
    queryFn: async () => {
  ...
  const {
    ...
    queryFn: async () => {
      const response = await axios.get(`${API_URL}/users?limit=1`, {
        withCredentials: true,
      });
  ...
  const handleProfilePhotoUpload = async (event) => {
    ...
    try {
      ...
      toast.success("Admin profile photo uploaded!");
    } catch (error) {
        ...
        <section className="overflow-hidden rounded-3xl border border-primary/10 bg-base-100 shadow-sm">
          ...
          <div className="px-5 pb-7 sm:px-7">
            <div className="-mt-16 flex flex-col items-center">
              ...
              <div className="mt-3 h-12 w-52 animate-pulse rounded-full bg-base-300" />
            </div>
          </div>
        </section>
  ...
  return (
    <>
      ...
      <div className="space-y-5">
        ...
        <section className="overflow-hidden rounded-3xl border border-primary/10 bg-base-100 shadow-sm">
          {/* Cover */}
          <div className="relative h-32 overflow-hidden bg-primary/10 sm:h-40">
            <div className="absolute -right-10 -top-20 h-56 w-56 rounded-full bg-primary/10 blur-3xl" />

            <div className="absolute left-6 top-5 flex items-center gap-2 rounded-full border border-primary/20 bg-base-100/80 px-4 py-2 text-primary shadow-sm backdrop-blur">
              <ShieldCheck className="h-5 w-5" />

              <span className="text-sm font-bold">Administrator Account</span>
            </div>
          </div>
          ...
          <div className="px-5 pb-8 sm:px-7">
            <div className="-mt-16 flex flex-col items-center text-center">
              ...
              <div className="relative">
                <div className="h-32 w-32 overflow-hidden rounded-full border-4 border-base-100 bg-base-200 shadow-xl sm:h-36 sm:w-36">
                  {user?.profilePhoto ? (
                    <img
              ...
              <div className="mt-5">
                <div className="inline-flex items-center gap-3 rounded-2xl border-2 border-primary/25 bg-primary/10 px-6 py-3 text-primary shadow-sm">
              ...
              <div className="mt-5 w-full max-w-2xl">
                <p className="text-sm leading-6 text-base-content/70">
                  {user?.bio ||
                    "Manage your photography platform, bookings, users, packages and reviews from the administrator dashboard."}
                </p>
              </div>
        ...
        <section className="rounded-3xl border border-primary/10 bg-base-100 p-5 shadow-sm sm:p-7">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-warning/15 bg-warning/5 p-5">
            ...
            <div className="rounded-2xl border border-info/15 bg-info/5 p-5">
        ...
        <section className="rounded-3xl border border-primary/10 bg-base-100 p-5 shadow-sm sm:p-7">
          <div className="mb-5">
            ...
            <p className="mt-1 text-xs text-base-content/50">
              Your role and account privileges.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-primary/15 bg-primary/5 p-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-base-content/50">Current Role</p>
            ...
            <div className="rounded-2xl border border-success/15 bg-success/5 p-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-base-content/50">Access Level</p>
        ...
        {(bookingsError || reviewsError || usersError) && (
          <div className="rounded-2xl border border-warning/20 bg-warning/10 p-4 text-sm text-warning-content">
            Some administrator statistics could not be loaded. Your main profile
            is still available.
          </div>
        )}
      </div>
            ...
            <form onSubmit={handleSaveProfile} className="space-y-5 p-5 sm:p-7">
              ...
              <div>
                ...
                <textarea
                  ...
                  value={formData.bio}
                  onChange={handleChange}
                  placeholder="Tell something about your role..."
                  rows={4}
                  maxLength={300}
