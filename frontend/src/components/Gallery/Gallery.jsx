...
const Gallery = () => {
  ...
  const publishedPhotos = photos.filter(
    (photo) => photo?.isPublished === true,
  );

  const photosLoadingState =
    photosLoading || photosFetching;

  const videosLoadingState =
          ...
          <div className="mb-10 flex flex-col gap-6 sm:mb-12 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl text-sm leading-7 text-base-content/60 sm:text-base">
                A collection of our favorite photographs from
                weddings, celebrations, portraits, and special
                moments.
              </p>

              <p className="mt-1 max-w-xl text-xs leading-6 text-base-content/50 sm:text-sm">
                বিয়ে, অনুষ্ঠান, পোর্ট্রেট এবং বিশেষ মুহূর্তের
                কিছু প্রিয় ছবি।
              </p>
          ...
          <div className="mb-10 flex flex-col gap-6 sm:mb-12 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl text-sm leading-7 text-base-content/60 sm:text-base">
                ...
                celebrations, stories, and memorable moments
                captured in motion.
              </p>

              <p className="mt-1 max-w-xl text-xs leading-6 text-base-content/50 sm:text-sm">
                বিয়ের গল্প, আনন্দের মুহূর্ত এবং সুন্দর স্মৃতিগুলো
                এবার ভিডিওতে দেখুন।
              </p>
        ...
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-8">
          ...
          <div className="rounded-3xl border border-primary/10 bg-primary/5 px-6 py-10 sm:px-10 sm:py-14">
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-base-content/60">
              Discover more photographs and films from our
              complete collection.
            </p>
